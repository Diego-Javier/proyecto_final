...
<head>
    ...
    <style>
        body{
            background-image: url(imagenes/fondo-buscar.jpg);
    height: 100%;
    ...
    <div class="grupo-1">
        ...
        <div class="box">
            ...
            <div class="red-social">
                <a href=""> <img src="{{asset('icon/facebook.svg')}}" class="icon" ></a>
                <a href=""> <img src="{{asset('icon/instagram.svg')}}" class="icon"></a>
                <a href=""> <img src="{{asset('icon/youtube.svg')}}" class="icon"></a>
                <a href=""> <img src="{{asset('icon/twitter.svg')}}" class="icon"></a>
            </div>
        </div>
    </div>
    <div class="grupo-2">
        <small>&copy; 2022 <b>Soy Indie</b> - Todos los Derechos Reservados.</small>
    </div>
</footer>
